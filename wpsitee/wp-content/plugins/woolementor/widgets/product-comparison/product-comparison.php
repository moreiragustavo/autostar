...
class Product_Comparison extends Widget_Base {
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			...
			[
				'label' 		=> __( 'Data', 'codesigner' ),
				'type' 			=> Controls_Manager::SELECT2,
				'multiple' 		=> false,
				'label_block' 	=> true,
				'options' 		=> [
					'price'  			=> __( 'Price', 'codesigner' ),
					'average_rating'  	=> __( 'Average Rating', 'codesigner' ),
					'description'  		=> __( 'Description', 'codesigner' ),
					'short_description'	=> __( 'Short Description', 'codesigner' ),
					'attributes'		=> __( 'Attributes', 'codesigner' ),
					'categories'		=> __( 'Categories', 'codesigner' ),
					'tags'				=> __( 'Tags', 'codesigner' ),
					'meta_fields'		=> __( 'Meta Fields', 'codesigner' ),
				],
				'default' 		=> 'price',
			]
		);
		...
		$repeater->add_control(
			...
			[
				'label' 		=> __( 'Meta Field', 'codesigner' ),
				'type' 			=> Controls_Manager::SELECT2,
				'multiple' 		=> false,
				'label_block' 	=> true,
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'product_comparison_label' => __( 'Price', 'codesigner' ),
						'product_comparison_value' => 'price',
					],
					[
						'product_comparison_label' => __( 'Average Rating', 'codesigner' ),
						'product_comparison_value' => 'average_rating',
					],
					[
						'product_comparison_label' => __( 'Short Description', 'codesigner' ),
						'product_comparison_value' => 'short_description',
					],
					[
						'product_comparison_label' => __( 'Categories', 'codesigner' ),
		...
		$this->start_controls_section(
			...
			[
				'label' 		=> __( 'Search Section', 'codesigner' ),
				'tab' 			=> Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'separator'	=> 'before',
				'default' 	=> '',
                'description'   => sprintf( __( 'Check this to enable <a href="%s" target="_blank">Chosen</a> jQuery library', 'codesigner' ), 'https://plugins.jquery.com/chosen/' ),
                'condition'	=> [
                	'show_button' => 'yes'
                ]
			]
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Select Box', 'codesigner' ),
				'tab'   => Controls_Manager::TAB_STYLE,
				'condition' => [
					'show_button' => 'yes'
				]
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Search Button', 'codesigner' ),
				'tab'   => Controls_Manager::TAB_STYLE,
				'condition' => [
					'show_button' => 'yes'
				]
