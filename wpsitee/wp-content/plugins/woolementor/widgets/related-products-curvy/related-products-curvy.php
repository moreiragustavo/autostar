                                ...
                                <div class="wl-rpcr-product-details">
                                    ...
                                    <div class="wl-rpcr-info-icons">
                                        ...
                                        <div class="wl-rpcr-product-fav">
                                            ...
                                            <a href="#" class="ajax_add_to_wish <?php echo esc_attr( $fav_item ); ?>" data-product_id="<?php esc_attr_e( $product_id ); ?>">
                                            ...
                                            if ( 'simple' == $product->get_type() ): ?>
                                                <div class="wl-rpcr-product-cart">
                                                    <div class="wl-cart-area">
                                                        <a href="?add-to-cart=<?php esc_attr_e( $product_id ); ?>" data-quantity="1" class="product_type_<?php echo esc_attr( $product->get_type() ); ?> add_to_cart_button ajax_add_to_cart" data-product_id="<?php esc_attr_e( $product_id ); ?>" ><i class="<?php echo esc_attr( $cart_icon['value'] ); ?>"></i></a>
                                                    </div>
                                                </div>
                                            <?php else: ?>
                                                <div class="wl-rpcr-product-cart">
